...
| :------------: | :------------------------------------: | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :------------: | :---------------: | :------------------------------------------------------------------------------------------: |
|      name      |        Type of task to execute         | `Data-Handler` <br/> `Infinite-Handler` <br/>`Delete-Handler`<br/>`Callback-Handler` <br/> `Update-Handler` <br/> `Update-Key-Handler` <br/>`Toggle-Key-Handler` <br/> `Splice-Data-Handler` <br/> `Delete-Key-Handler` <br/> `Don't-Update-Data-Handler` <br/> `Custom-Handler` | `Data-Handler` |     `string`      |                                  `{ name: 'Data-Handler' }`                                  |
...
|    callback    |                                        |                                                                                                                                    `function`                                                                                                                                    |     `null`     |    `function`     | `{updateCallback: (previousData,responseData) =>` <br/> `previousData.concat(responseData)}` |
